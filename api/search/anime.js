...
export const neoNimesearch = async (query) => {
    try {
        return await neoNime.search(query);
    } catch (error) {
        console.error('Error during NeoNime search:', error);
        throw error;
    }
};

export const neoNimedetail = async (url) => {
    try {
        return await neoNime.detail(url);
    } catch (error) {
        console.error('Error fetching NeoNime detail:', error);
        throw error;
    }
};

const anoboy = new Anoboy();
export const anoboysearch = async (query) => {
    try {
        return await anoboy.search(query);
    } catch (error) {
        console.error('Error during Anoboy search:', error);
        throw error;
    }
};

export const anoboydetail = async (url) => {
    try {
        return await anoboy.detail(url);
    } catch (error) {
        console.error('Error fetching Anoboy detail:', error);
        throw error;
    }
};

const otakudesu = new Otakudesu();
export const otakudesusearch = async (query) => {
    try {
        return await otakudesu.search(query);
    } catch (error) {
        console.error('Error during Otakudesu search:', error);
        throw error;
    }
};

export const otakudesudetail = async (url) => {
    try {
        return await otakudesu.detail(url);
    } catch (error) {
        console.error('Error fetching Otakudesu detail:', error);
        throw error;
    }
};

const kiryuu = new Kiryuu();
export const kiryuusearch = async (query) => {
    try {
        return await kiryuu.search(query);
    } catch (error) {
        console.error('Error during Kiryuu search:', error);
        throw error;
    }
};

export const kiryuudetail = async (url) => {
    try {
        return await kiryuu.detail(url);
    } catch (error) {
        console.error('Error fetching Kiryuu detail:', error);
        throw error;
    }
};

const mangatoon = new MangaToon();
export const mangatoonsearch = async (query) => {
    try {
        return await mangatoon.search(query);
    } catch (error) {
        console.error('Error during MangaToon search:', error);
        throw error;
    }
};

export const mangatoondetail = async (url) => {
    try {
        return await mangatoon.detail(url);
    } catch (error) {
        console.error('Error fetching MangaToon detail:', error);
        throw error;
    }
};

const kusonime = new Kusonime();
export const kusonimesearch = async (query) => {
    try {
        return await kusonime.search(query);
    } catch (error) {
        console.error('Error during Kusonime search:', error);
        throw error;
    }
};

export const kusonimedetail = async (url) => {
    try {
        return await kusonime.detail(url);
    } catch (error) {
...
export const komikusearch = async (query) => {
    try {
        return await komiku.search(query);
    } catch (error) {
        console.error('Error during Komiku search:', error);
        throw error;
    }
};

export const komikudetail = async (url) => {
    try {
        return await komiku.detail(url);
    } catch (error) {
        console.error('Error fetching Komiku detail:', error);
        throw error;
    }
};

const animebatch = new AnimeBatch();
export const animebatchsearch = async (query) => {
    try {
        return await animebatch.search(query);
    } catch (error) {
        console.error('Error during AnimeBatch search:', error);
        throw error;
    }
};

export const animebatchdetail = async (url) => {
    try {
        return await animebatch.detail(url);
    } catch (error) {
        console.error('Error fetching AnimeBatch detail:', error);
        throw error;
    }
};

const doujindesu = new DoujinDesu();
export const doujindesusearch = async (query) => {
    try {
        return await doujindesu.search(query);
    } catch (error) {
        console.error('Error during DoujinDesu search:', error);
        throw error ;
    }
};

export const doujindesudetail = async (url) => {
    try {
        return await doujindesu.detail(url);
    } catch (error) {
        console.error('Error fetching DoujinDesu detail:', error);
        throw error;
    }
};

const nekopoi = new Nekopoi();
export const nekopoisearch = async (query) => {
    try {
        return await nekopoi.search(query);
    } catch (error) {
        console.error('Error during Nekopoi search:', error);
        throw error;
    }
};

export const nekopoidetail = async (url) => {
    try {
        return await nekopoi.detail(url);
    } catch (error) {
        console.error('Error fetching Nekopoi detail:', error);
        throw error;
    }
};

const nhentai = new Nhentai();
export const nhentaidesearch = async (query) => {
    try {
        return await nhentai.search(query);
    } catch (error) {
        console.error('Error during Nhentai search:', error);
        throw error;
    }
};

export const nhentaidetail = async (url) => {
    try {
        return await nhentai.detail(url);
    } catch (error) {
        console.error('Error fetching Nhentai detail:', error);
        throw error;
    }
};

const komikcast = new Komikcast();
export const komikcastsearch = async (query) => {
    try {
        return await komikcast.search(query);
    } catch (error) {
        console.error('Error during Komikcast search:', error);
        throw error;
    }
};

export const komikcastdetail = async (url) => {
    try {
        return await komikcast.detail(url);
    } catch (error) {
        console.error('Error fetching Komikcast detail:', error);
        throw error;
    }
};

const oploverz = new Oploverz();
export const oploverzsearch = async (query) => {
    try {
        return await oploverz.search(query);
    } catch (error) {
        console.error('Error during Oploverz search:', error);
        throw error;
    }
};

export const oploverzdetail = async (url) => {
    try {
        return await oploverz.detail(url);
    } catch (error) {
        console.error('Error fetching Oploverz detail:', error);
        throw error;
    }
};

const meganei = new Meganei();
export const meganeisearch = async (query) => {
    try {
        return await meganei.search(query);
    } catch (error) {
        console.error('Error during Meganei search:', error);
        throw error;
    }
};

export const meganeidetail = async (url) => {
    try {
        return await meganei.detail(url);
    } catch (error) {
        console.error('Error fetching Meganei detail:', error);
        throw error;
    }
};