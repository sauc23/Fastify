...
class IlovePDF {
  ...
  async process(links, tool, payload) {
    try {
...
const ilovePdf = async (links, tool, payload) => {
    try {
        return await ilovePDF.process(links, tool, payload);
    } catch (error) {
        console.error('Error during processing in IlovePDF:', error);
        throw error;
    }
};
