...
class Ondoku {
  ...
  async imageToSpeech(imgUrl, voiceId = "id-ID-Wavenet-B", speed = "1", pitch = "0") {
    try {
    const base64Image = (await (await fetch(imgUrl)).arrayBuffer());
...
export const textToSpeech = async (text, voiceId = "id-ID-Wavenet-B", speed = "1", pitch = "0") => {
    try {
        return await ondoku.textToSpeech(text, voiceId, speed, pitch);
    } catch (error) {
...
export const imageToSpeech = async (imgUrl, voiceId = "id-ID-Wavenet-B", speed = "1", pitch = "0") => {
    try {
        return await ondoku.imageToSpeech(imgUrl, voiceId, speed, pitch);
    } catch (error) {
