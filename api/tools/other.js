...
export const elevenModel = async (name) => {
    try {
        return await tools.elevenModel(name);
    } catch (error) {
        console.error('Error in elevenModel:', error);
        throw error;
    }
};

export const soundText = async (text, voice) => {
    try {
        return await tools.soundText(text, voice);
    } catch (error) {
        console.error('Error in soundText:', error);
        throw error;
    }
};
...
export const detectLang = async (text) => {
    try {
        return await tools.detectLang(text);
    } catch (error) {
        console.error('Error in detectLang:', error);
        throw error;
    }
};

export const elevenlabs = async (text, model) => {
    try {
        return await tools.elevenlabs(text, model);
    } catch (error) {
...
export const detectText = async (text) => {
    try {
        return await tools.detectText(text);
    } catch (error) {
...
export const rangkum = async (text) => {
    try {
        return await tools.rangkum(text);
    } catch (error) {
        console.error('Error in rangkum:', error);
        throw error;
    }
};

export const SimSimi = async (teks) => {
    try {
        return await tools.SimSimi(teks);
    } catch (error) {
        console.error('Error in SimSimi:', error);
        throw error;
    }
};

export const blacbox = async (query) => {
    try {
        return await tools.blacbox(query);
    } catch (error) {
        console.error('Error in blacbox:', error);
        throw error;
    }
};

export const code = async (text, input, code) => {
    try {
        return await tools.code(text, input, code);
    } catch (error) {
...
export const webpage = async (text) => {
    try {
        return await tools.webpage(text);
    } catch (error) {
...
export const speech = async (text, type) => {
    try {
        return await tools.speech(text, type);
    } catch (error) {
...
export const ssweb = async (url, device = "desktop") => {
    try {
        return await tools.ssweb(url, device);
    } catch (error) {
