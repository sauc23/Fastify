...
export async function apngToAvif(url) {
...
export async function apngToGif(url) {
  return await convert({
    type: "apng-gif",
    url: url
  });
...
export async function apngToMp4(url) {
  return await convert({
    type: "apng-mp4",
    url: url
  });
...
export async function apngToWebp(url) {
  return await convert({
    type: "apng-webp",
    url: url
  });
...
export async function avifToGif(url) {
  return await convert({
    type: "avif-gif",
    url: url
  });
...
export async function avifToJpg(url) {
  return await convert({
    type: "avif-jpg",
    url: url
  });
...
export async function avifToPng(url) {
  return await convert({
    type: "avif-png",
    url: url
  });
...
export async function bmpToGif(url) {
  return await convert({
    type: "bmp-gif",
    url: url
  });
...
export async function bmpToJpg(url) {
  return await convert({
    type: "bmp-jpg",
    url: url
  });
...
export async function bmpToPng(url) {
  return await convert({
    type: "bmp-png",
    url: url
  });
...
export async function gifToApng(url) {
  return await convert({
    type: "gif-apng",
    url: url
  });
...
export async function gifToAvif(url) {
  return await convert({
    type: "gif-avif",
    url: url
  });
...
export async function gifToJpg(url) {
  return await convert({
    type: "gif-jpg",
    url: url
  });
...
export async function gifToPng(url) {
  return await convert({
    type: "gif-png",
    url: url
  });
...
export async function gifToSprite(url) {
  return await convert({
    type: "gif-sprite",
    url: url
  });
...
export async function gifToWebp(url) {
  return await convert({
    type: "gif-webp",
    url: url
  });
...
export async function jpgToAvif(url) {
  return await convert({
    type: "jpg-avif",
    url: url
  });
...
export async function jpgToWebp(url) {
  return await convert({
    type: "jpg-webp",
    url: url
  });
...
export async function mngToApng(url) {
  return await convert({
    type: "mng-apng",
    url: url
  });
...
export async function pngToBmp(url) {
  return await convert({
    type: "png-bmp",
    url: url
  });
...
export async function pngToGif(url) {
  return await convert({
    type: "png-gif",
    url: url
  });
...
export async function pngToJpg(url) {
  return await convert({
    type: "png-jpg",
    url: url
  });
...
export async function pngToWebp(url) {
  return await convert({
    type: "png-webp",
    url: url
  });
...
export async function spriteToImg(url) {
  return await convert({
    type: "sprite-img",
    url: url
  });
...
export async function spriteToImage(url) {
  return await convert({
    type: "sprite-imgage",
    url: url
  });
...
export async function svgToJpg(url) {
  return await convert({
    type: "svg-jpg",
    url: url
  });
...
export async function svgToPng(url) {
  return await convert({
    type: "svg-png",
    url: url
  });
...
export async function videoToApng(url) {
  return await convert({
    type: "video-apng",
    url: url
  });
...
export async function videoToAvif(url) {
  return await convert({
    type: "video-avif",
    url: url
  });
...
export async function videoToGif(url) {
  return await convert({
    type: "video-gif",
    url: url
  });
...
export async function videoToJpg(url) {
  return await convert({
    type: "video-jpg",
    url: url
  });
...
export async function videoToPng(url) {
 return await convert({
    type: "video-png",
    url: url
  });
...
export async function videoToWebp(url) {
  return await convert({
    type: "video-webp",
    url: url
  });
...
export async function webpToAvif(url) {
  return await convert({
    type: "webp-avif",
    url: url
  });
...
export async function webpToGif(url) {
  return await convert({
    type: "webp-gif",
    url: url
  });
...
export async function webpToJpg(url) {
  return await convert({
    type: "webp-jpg",
    url: url
  });
...
export async function webpToMp4(url) {
  return await convert({
    type: "webp-mp4",
    url: url
  });
...
export async function webpToPng(url) {
  return await convert({
    type: "webp-png",
    url: url
  });
