...
async function arti_kartu_tarot(a, t, n) {
  return await primbon.arti_kartu_tarot(a, t, n);
}

async function arti_nama(a) {
  return await primbon.arti_nama(a);
}

async function cek_potensi_penyakit(a, t, n) {
  return await primbon.cek_potensi_penyakit(a, t, n);
}

async function hari_sangar_taliwangke(a, t, n) {
  return await primbon.hari_sangar_taliwangke(a, t, n);
}

async function kecocokan_nama(a, t, n, i) {
  return await primbon.kecocokan_nama(a, t, n, i);
}

async function kecocokan_nama_pasangan(a, t) {
  return await primbon.kecocokan_nama_pasangan(a, t);
}

async function masa_subur(a, t, n, i = "28") {
  return await primbon.masa_subur(a, t, n, i);
}

async function nomer_hoki(a) {
  return await primbon.nomer_hoki(a);
}

async function pekerjaan_weton_lahir(a, t, n) {
  return await primbon.pekerjaan_weton_lahir(a, t, n);
}

async function perhitungan_feng_shui(a, t, n) {
  return await primbon.perhitungan_feng_shui(a, t, n);
}

async function petung_hari_baik(a, t, n) {
  return await primbon.petung_hari_baik(a, t, n);
}

async function potensi_keberuntungan(a, t, n, i) {
  return await primbon.potensi_keberuntungan(a, t, n, i);
}

async function primbon_arah_rejeki(a, t, n) {
  return await primbon.primbon_arah_rejeki(a, t, n);
}

async function primbon_hari_naas(a, t, n) {
  return await primbon.primbon_hari_naas(a, t, n);
}

async function primbon_memancing_ikan(a, t, n) {
  return await primbon.primbon_memancing_ikan(a, t, n);
}

async function rahasia_naga_hari(a, t, n) {
  return await primbon.rahasia_naga_hari(a, t, n);
}

async function ramalan_cinta(a, t, n, i, e, s, r, l) {
  return await primbon.ramalan_cinta(a, t, n, i, e, s, r, l);
}

async function ramalan_jodoh(a, t, n, i, e, s, r, l) {
  return await primbon.ramalan_jodoh(a, t, n, i, e, s, r, l);
}

async function ramalan_jodoh_bali(a, t, n, i, e, s, r, l) {
  return await primbon.ramalan_jodoh_bali(a, t, n, i, e, s, r, l);
}

async function ramalan_nasib(a, t, n) {
  return await primbon.ramalan_nasib(a, t, n);
}

async function ramalan_peruntungan(a, t, n, i, e) {
  return await primbon.ramalan_peruntungan(a, t, n, i, e);
}

async function rejeki_hoki_weton(a, t, n) {
  return await primbon.rejeki_hoki_weton(a, t, n);
}

async function shio(a) {
  return await primbon.shio(a);
}

async function sifat_karakter_tanggal_lahir(a, t, n, i) {
  return await primbon.sifat_karakter_tanggal_lahir(a, t, n, i);
}

async function sifat_usaha_bisnis(a, t, n) {
  return await primbon.sifat_usaha_bisnis(a, t, n);
}

async function suami_istri(a, t, n, i, e, s, r, l) {
  return await primbon.suami_istri(a, t, n, i, e, s, r, l);
}

async function tafsir_mimpi(a) {
  return await primbon.tafsir_mimpi(a);
}

async function tanggal_jadian_pernikahan(a, t, n) {
  return await primbon.tanggal_jadian_pernikahan(a, t, n);
}

async function weton_jawa(a, t, n) {
  return await primbon.weton_jawa(a, t, n);
}

async function zodiak(a) {
  return await primbon.zodiak(a);
}
