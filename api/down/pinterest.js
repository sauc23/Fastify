...
const video = async (link) => {
    try {
        return await pinterestDownloader.videoDown(link);
    } catch (error) {
...
const image = async (link) => {
    try {
        return await pinterestDownloader.imageDown(link);
    } catch (error) {
